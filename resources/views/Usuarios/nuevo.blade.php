...
<div class="container col-md-6 rounded shadow p-3 mt-4">
    <form role="form" action="{{route('usuario.store')}}" method="POST">
        ...
        <fieldset>
          ...
          <div class="mb-3">
            <div class="mb-3">
                <p><strong>Codigo del usuario: {{$codigo}}</strong></p>
                <input type="hidden" id="id" name="id" class="form-control" placeholder="Codigo Cupon" value="{{$codigo}}">
              </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            <div class="mb-3">
                ...
                <input type="text" id="Nombre_Usuario" name="Nombre_Usuario" class="form-control" placeholder="Nombre" value="{{old('Nombre_Usuario')}}">
              </div>
          </div>
          <div class="mb-3">
            <label for="Identificacion_Usuario" class="form-label">Identificacion:</label>
            <input type="text" id="Identificacion_Usuario" name="Identificacion_Usuario" class="form-control" placeholder="00000000-0" value="{{old('Identificacion_Usuario')}}">
          </div>
          <div class="mb-3">
            <label for="Fecha_Nacimiento_Usuario" class="form-label">Fecha de nacimiento:</label>
            <input type="date" id="Fecha_Nacimiento_Usuario" name="Fecha_Nacimiento_Usuario" class="form-control" value="{{old('Fecha_Nacimiento_Usuario')}}">
          </div>
          <div class="mb-3">
            <div class="mb-3">
                <label for="Correo_Usuario" class="form-label">Correo electronico:</label>
                <input type="email" id="Correo_Usuario" name="Correo_Usuario" class="form-control" placeholder="usuario@cuponera.com" value="{{old('Correo_Usuario')}}">
              </div>
          </div>
          <div class="mb-3">
          ...
          <div class="mb-3">
            ...
            <select id="Estado_Usuario" class="form-select form-select-lg  mi-selector" name="Estado_Usuario" >
                <option value='1' {{old('Estado_Usuario')==1?'selected':'';}}>Activo</option>
                <option value='0' {{old('Estado_Usuario')==0?'selected':'';}}>Dehabilitado</option>
            </select>
        </div>
